...
*/ var OVERLAY_ID = "__parcel__error__overlay__";
    ...
    "4DUL7": [
      ...
      },
      {
        ...
        "./thunk": "casGH",
        "./vnode": "kyZ4D",
        "./helpers/attachto": "5JDmw",
        "./is": "29RCV",
        "./tovnode": "kK62S",
        "./h": "g3cyU",
        "./hooks": "5xE12",
        "./modules/attributes": "bzicr",
        "./modules/class": "bPT7Q",
        "./modules/dataset": "3XI37",
        "./modules/eventlisteners": "lCFds",
        "./modules/props": "a174r",
        "./modules/style": "hDLMz",
        "./jsx": "kNOq3",
        "@parcel/transformer-js/src/esmodule-helpers.js": "fwhFv",
      },
    ],
    gEP2V: [
      function (require, module, exports) {
        ...
        function init(modules, domApi) {
          ...
          function createElm(vnode, insertedVnodeQueue) {
            ...
            if (sel === "!") {
              ...
              if (_is.array(children))
                for (i = 0; i < children.length; ++i) {
                  const ch = children[i];
                  if (ch != null)
                    api.appendChild(elm, createElm(ch, insertedVnodeQueue));
                }
              else if (_is.primitive(vnode.text))
                api.appendChild(elm, api.createTextNode(vnode.text));
              const hook1 = vnode.data.hook;
              if (isDef(hook1)) {
                (_b = hook1.create) === null ||
                  _b === void 0 ||
                  _b.call(hook1, emptyNode, vnode);
          ...
          function invokeDestroyHook(vnode) {
            ...
            if (data !== undefined) {
              (_b =
                (_a = data === null || data === void 0 ? void 0 : data.hook) ===
                  null || _a === void 0
                  ? void 0
                  : _a.destroy) === null ||
                _b === void 0 ||
            ...
            for (; startIdx <= endIdx; ++startIdx) {
              ...
              if (ch != null) {
                if (isDef(ch.sel)) {
                  ...
                  const removeHook =
                    (_b =
                      (_a = ch === null || ch === void 0 ? void 0 : ch.data) ===
                        null || _a === void 0
                        ? void 0
          ...
          function patchVnode(oldVnode, vnode, insertedVnodeQueue) {
            ...
            (_b =
              hook1 === null || hook1 === void 0 ? void 0 : hook1.prepatch) ===
              null ||
              _b === void 0 ||
              _b.call(hook1, oldVnode, vnode);
            ...
            (_e =
              hook1 === null || hook1 === void 0 ? void 0 : hook1.postpatch) ===
              null ||
              _e === void 0 ||
              _e.call(hook1, oldVnode, vnode);
          }
      ...
      function (require, module, exports) {
        ...
        function h(sel, b, c) {
          ...
          if (children !== undefined) {
            for (i = 0; i < children.length; ++i)
              if (_is.primitive(children[i]))
                children[i] = _vnode.vnode(
                  undefined,
                  undefined,
                  undefined,
                  children[i],
      ...
      function (require, module, exports) {
        ...
        function toVNode(node, domApi) {
          ...
          if (api.isElement(node)) {
            ...
            text = api.getTextContent(node);
            return _vnode.vnode("!", {}, [], text, node);
          } else return _vnode.vnode("", {}, [], undefined, node);
        }
      },
      {
        "./vnode": "kyZ4D",
      ...
      function (require, module, exports) {
        ...
        function updateEventListeners(oldVnode, vnode) {
          ...
          if (oldOn && oldListener) {
            ...
            if (!on)
              for (name in oldOn) // remove listener if element was changed or existing listeners removed
          ...
          if (on) {
            ...
            if (!oldOn)
              for (name in on) // add listener if element was changed or new listeners added
